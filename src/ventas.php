                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="pro_cliente" id="pro_cliente" class="form-control" disabled required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Localidad</label>
                                <input type="text" name="loc_cliente" id="loc_cliente" class="form-control" disabled required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>CP</label>
                                <input type="number" name="cp_cliente" id="cp_cliente" class="form-control" disabled required>
                            </div>
                        </div>
                    </div>
                </form>
